...
from nlp_celery_worker.nlp_helpers.summarizer import initialize_summarizer, generate_summary_from_sentences
...
class TestSummarizer(TestCase):
    ...
    @patch('nlp_celery_worker.nlp_helpers.summarizer.download')
